...
?>
    ...
    <form id="contact" action="assets/php/form_valid.php" method="POST">
        ...
        <div class="form-group text-center">
            ...
            <button type="submit" class="btn btn-primary mb-2" value="envoiContact">Envoyer</button>
            <button type="reset" class="btn btn-outline-secondary mb-2 ml-2" value="resetContact">Annuler</button>
        </div>
    </form>

<?php
    include("assets/php/footerContact.php");    
?>